...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_coins":
        ...
        allowed_users = [8172637443, 5041626933, 5229178575, 6858542775]  # add the Telegram IDs of buyers here
