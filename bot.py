...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "⚠️ TG BACKUP: https://t.me/+eYG71RALj2g5NThh\n"
        "⚠️ Discord(free 20 coins): https://discord.gg/WVFXVkDEz3\n"
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_coins":
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("🎁 Join dc and get free 20 coins", url="https://discord.gg/WVFXVkDEz3")],
        ...
        voucher_keyboard = [
            ...
            [InlineKeyboardButton("📩Contact Support", url="https://t.me/BushersSupport")],  # <-- new button
        ...
        allowed_users = [8172637443, 5041626933, 5229178575, 6858542775, 7216731920, 8194528857, 5130502442, 8495319504, 8456491775, 6134347475, 6381129054, 5641807440, 5502910136, 6273736774, 7891905177, 5641807440, 5765378406, 6949813033, 8210921874, 6647369395, 8363349943, 5704756990, 8335151938, 985772348, 8462172869 ]  # add the Telegram IDs of buyers here
